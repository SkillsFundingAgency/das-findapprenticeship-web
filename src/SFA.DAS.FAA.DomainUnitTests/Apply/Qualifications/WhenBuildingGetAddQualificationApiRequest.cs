...
public class WhenBuildingGetAddQualificationApiRequest
{
    ...
    {
        var actual = new GetAddQualificationApiRequest(qualificationReferenceId, applicationId);

        actual.GetUrl.Should().Be($"applications/{applicationId}/qualifications/{qualificationReferenceId}/add");
    }
}