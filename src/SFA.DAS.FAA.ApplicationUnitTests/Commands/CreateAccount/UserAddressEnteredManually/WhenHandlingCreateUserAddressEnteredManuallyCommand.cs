...
namespace SFA.DAS.FAA.Application.UnitTests.Commands.CreateAccount.UserAddressEnteredManually;
public class WhenHandlingCreateUserAddressEnteredManuallyCommand
{
        ...
        UpdateManuallyEnteredAddressCommandHandler handler)
    {
        ...
        apiClientMock.Setup(x =>
                x.Post(It.Is<CreateUserManuallyEnteredAddressApiRequest>(c =>
