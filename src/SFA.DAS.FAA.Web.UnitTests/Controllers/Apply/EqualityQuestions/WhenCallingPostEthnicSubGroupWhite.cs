...
namespace SFA.DAS.FAA.Web.UnitTests.Controllers.Apply.EqualityQuestions
{
    ...
    public class WhenCallingPostEthnicSubGroupWhite
    {
            ...
            [Frozen] Mock<ICacheStorageService> cacheStorageService)
        {
            ...
            var actual = await controller.EthnicGroupWhite(applicationId, viewModel) as ViewResult;
                ...
                [Frozen] Mock<ICacheStorageService> cacheStorageService)
        {
            ...
            var actual = await controller.EthnicGroupWhite(applicationId, viewModel) as RedirectToRouteResult;
