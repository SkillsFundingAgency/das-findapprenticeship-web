...
namespace SFA.DAS.FAA.Web.UnitTests.Models
{
    public class WhenCreatingVacancyDetailsViewModel
    {
            ...
            [Frozen] Mock<IDateTimeService> dateTimeService)
        {
            ...
            Assert.AreEqual(workingHours, actual.HoursPerWeek);
        }
            ...
            [Frozen] Mock<IDateTimeService> dateTimeService)
        {
            ...
            Assert.NotNull(actual.ClosingDate);
            Assert.True(actual.ClosingDate?.Contains("Closes in"));
        }
            ...
            [Frozen] Mock<IDateTimeService> dateTimeService)
        {
            ...
            Assert.NotNull(actual.ClosingDate);
            Assert.True(actual.ClosingDate?.Contains("Closes on"));
        }
    }
}
